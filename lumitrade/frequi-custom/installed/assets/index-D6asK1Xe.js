import{Y as S,ah as k,Z as w,ai as O,aN as m,aq as V,R as A,a as g,c as p,e as h,a0 as y,P as z,E as s,n as I,t as B,ae as f,aT as c,J as C,F as K,r as $,l as x,aV as D,w as E}from"./index-C-S3pgyS.js";var R=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,W={root:function(e){var n=e.props,l=e.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":n.fluid}]}},Z=S.extend({name:"selectbutton",style:U,classes:W}),G={name:"BaseSelectButton",extends:w,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:Z,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function Q(t,e){var n=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=T(t))||e){n&&(t=n);var l=0,a=function(){};return{s:a,n:function(){return l>=t.length?{done:!0}:{done:!1,value:t[l++]}},e:function(d){throw d},f:a}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
...
//# sourceMappingURL=index-D6asK1Xe.js.map
