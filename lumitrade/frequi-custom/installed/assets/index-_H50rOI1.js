import{a0 as S,ag as k,a1 as O,ah as w,aL as m,ap as A,Y as V,a as g,c as p,f as h,a3 as y,n as z,N as s,j as I,A as B,ad as f,aR as c,Q as C,F as K,k as $,l as x,aT as D,h as E}from"./index-BdWsFgit.js";var R=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,W={root:function(e){var n=e.props,l=e.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":n.fluid}]}},G=S.extend({name:"selectbutton",style:U,classes:W}),J={name:"BaseSelectButton",extends:O,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:G,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function X(t,e){var n=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=T(t))||e){n&&(t=n);var l=0,i=function(){};return{s:i,n:function(){return l>=t.length?{done:!0}:{done:!1,value:t[l++]}},e:function(d){throw d},f:i}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var o,a=!0,r=!1;return{s:function(){n=n.call(t)},n:function(){var d=n.next();return a=d.done,d},e:function(d){r=!0,o=d},f:function(){try{a||n.return==null||n.return()}finally{if(r)throw o}}}}function Z(t){return nt(t)||et(t)||T(t)||tt()}function tt(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function T(t,e){if(t){if(typeof t=="string")return v(t,e);var n={}.toString.call(t).slice(8,-1);return n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set"?Array.from(t):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?v(t,e):void 0}}function et(t){if(typeof Symbol<"u"&&t[Symbol.iterator]!=null||t["@@iterator"]!=null)return Array.from(t)}function nt(t){if(Array.isArray(t))return v(t)}function v(t,e){(e==null||e>t.length)&&(e=t.length);for(var n=0,l=Array(e);n<e;n++)l[n]=t[n];return l}var ot={name:"SelectButton",extends:J,inheritAttrs:!1,emits:["change"],methods:{getOptionLabel:function(e){return this.optionLabel?c(e,this.optionLabel):e},getOptionValue:function(e){return this.optionValue?c(e,this.optionValue):e},getOptionRenderKey:function(e){return this.dataKey?c(e,this.dataKey):this.getOptionLabel(e)},isOptionDisabled:function(e){return this.optionDisabled?c(e,this.optionDisabled):!1},isOptionReadonly:function(e){if(this.allowEmpty)return!1;var n=this.isSelected(e);return this.multiple?n&&this.d_value.length===1:n},onOptionSelect:function(e,n,l){var i=this;if(!(this.disabled||this.isOptionDisabled(n)||this.isOptionReadonly(n))){var o=this.isSelected(n),a=this.getOptionValue(n),r;if(this.multiple)if(o){if(r=this.d_value.filter(function(u){return!f(u,a,i.equalityKey)}),!this.allowEmpty&&r.length===0)return}else r=this.d_value?[].concat(Z(this.d_value),[a]):[a];else{if(o&&!this.allowEmpty)return;r=o?null:a}this.writeValue(r,e),this.$emit("change",{originalEvent:e,value:r})}},isSelected:function(e){var n=!1,l=this.getOptionValue(e);if(this.multiple){if(this.d_value){var i=X(this.d_value),o;try{for(i.s();!(o=i.n()).done;){var a=o.value;if(f(a,l,this.equalityKey)){n=!0;break}}}catch(r){i.e(r)}finally{i.f()}}}else n=f(this.d_value,l,this.equalityKey);return n}},computed:{equalityKey:function(){return this.optionValue?null:this.dataKey},dataP:function(){return w({invalid:this.$invalid})}},directives:{ripple:k},components:{ToggleButton:L}},lt=["aria-labelledby","data-p"];function rt(t,e,n,l,i,o){var a=C("ToggleButton");return g(),p("div",s({class:t.cx("root"),role:"group","aria-labelledby":t.ariaLabelledby},t.ptmi("root"),{"data-p":o.dataP}),[(g(!0),p(K,null,$(t.options,function(r,u){return g(),x(a,{key:o.getOptionRenderKey(r),modelValue:o.isSelected(r),onLabel:o.getOptionLabel(r),offLabel:o.getOptionLabel(r),disabled:t.disabled||o.isOptionDisabled(r),unstyled:t.unstyled,size:t.size,readonly:o.isOptionReadonly(r),onChange:function(P){return o.onOptionSelect(P,r,u)},pt:t.ptm("pcToggleButton")},D({_:2},[t.$slots.option?{name:"default",fn:E(function(){return[y(t.$slots,"option",{option:r,index:u},function(){return[h("span",s({ref_for:!0},t.ptm("pcToggleButton").label),B(o.getOptionLabel(r)),17)]})]}),key:"0"}:void 0]),1032,["modelValue","onLabel","offLabel","disabled","unstyled","size","readonly","onChange","pt"])}),128))],16,lt)}ot.render=rt;export{ot as s};
//# sourceMappingURL=index-_H50rOI1.js.map
